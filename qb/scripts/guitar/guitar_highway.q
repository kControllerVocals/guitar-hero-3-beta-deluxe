...
script update_prepass_position 
	Obj_GetPosition
	prepass_distance = ($prepass_camera_pos.(0.0, 0.0, 1.0) - <pos>.(0.0, 0.0, 1.0))
	begin
	calculate_prepass_offset screen_element = <screen_element> distance = <prepass_distance>
	Obj_SetPosition position = (<prepass_offset> + $prepass_camera_pos)
	Obj_ForceUpdate
	Wait \{1
		gameframes}
	repeat
...
script create_highway_prepass_object roty = 0
	...
	<highway_prepass_name> :Obj_ForceUpdate
	<highway_prepass_name> :Obj_SpawnScriptLater update_prepass_position params = {screen_element = <container_id>}
endscript
...
script create_highway_prepass 
	...
	if ($current_num_players = 1)
		...
		create_highway_prepass_object <...> player_text = 'p1' x_offset = (0 - $x_offset_p2)
		create_highway_prepass_object <...> player_text = 'p2' x_offset = ($x_offset_p2)
	endif
...
script destroy_highway_prepass 
	...
	if CompositeObjectExists name = <name>
		<name> :Obj_KillSpawnedScript name = 0x468a2c20
		<name> :Die
	endif
