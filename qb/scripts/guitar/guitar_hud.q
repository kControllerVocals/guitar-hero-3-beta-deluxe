...
hud_screen_elements = [
	...
	{
		id = coop_raise_axe
		text = "Tilt guitar to trigger Star Power!"
		pos = (640.0, 300.0)
		scale = 0.7
		just = [
			center
...
script setup_hud 
	...
	if ((<player_status>.is_local_client) && (<player_status>.highway_layout = solo_highway))
		net_setup_solo_hud player_status = <player_status> hud_destroygroup = <hud_destroygroup>
	else
