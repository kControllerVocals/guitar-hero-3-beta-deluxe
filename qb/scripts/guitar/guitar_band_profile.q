Musician_Profiles = [
	...
	}
	{
		...
		blurb = "After realizing that the majority of her fan base were 14 year old boys, Judy dropped her label like a bad habit.  In her debut solo effort 'Punkagothic Rockabillica', Judy brings her own style and shows she can shred with the big boys and then some."
		outfits = [
			{
				name = "Rocker Grrl"
				id = 'judy_01'
	...
	}
	{
		...
		blurb = "As a member of Guns N' Roses, Slash's Snakepit, and Velvet Revolver, Slash has established himself as true Guitar Hero.  Known for his fiery bluesy playing style and his signature top hat, Slash is one of the most recognizable guitar players in Rock 'N Roll today."
	}
	{
		name = 'Morello'
	...
	}
	{
		...
		blurb = "Lou's his name and gathering souls in exchange for musical prowess is his game.  Meet him at the crossroads and leave your nerves on the porch or prepare to spend eternity tuing his guitars.  Loves red win.  Definitely a dog person."
		outfits = [
			{
				name = "Lou"
				id = 'satan'
	...
	}
	{
		...
		icon_off = Char_Select_Slash_Off
		icon_on = Char_Select_Slash_On
		blurb = "Once human, the God of Rock has ascended to the highest level of rocking and plays nightly in a small pub on Mount Olympus.  Occassionally, he finds time to guitar battle with mere humans.  He also is credited with inventing the lute."
	}
	{
		name = 'Ripper'
