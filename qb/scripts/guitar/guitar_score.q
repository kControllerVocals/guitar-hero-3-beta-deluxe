...
script 0x7c4f6c35 
	if (($new_net_logic) && ($<player_status>.player = 2))
		return
	endif
	get_current_multiplier player_status = <player_status>
	difficulty = $current_difficulty
	beat_time = ($<player_status>.playline_song_beat_time / 1000.0)
	additional_score = ($current_deltatime / <beat_time>)
	additional_score = (<additional_score> * $points_per_note_per_beat.<difficulty> * <multiplier>)
	change structurename = <player_status> score = ($<player_status>.score + <additional_score>)
endscript
