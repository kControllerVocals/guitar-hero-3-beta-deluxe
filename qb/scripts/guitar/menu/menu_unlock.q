...
script create_unlock_menu 
	...
	unlock_item_tex = 0xa9bbb22c
	unlock_item_name = "GOTHBAT"
	unlock_font = text_a4
	...
	fit_text_in_rectangle id = unlock_text_congrats dims = (350.0, 32.0) pos = (680.0, 485.0)
	CreateScreenElement {
		type = TextElement
	...
	fit_text_in_rectangle id = unlock_text_buyitinthestore dims = (350.0, 32.0) pos = (680.0, 570.0)
	CreateScreenElement {
		type = TextElement
		id = unlock_text_name
		parent = unlock_container
	...
	fit_text_in_rectangle id = unlock_text_name dims = (350.0, 64.0) pos = (680.0, 514.0)
