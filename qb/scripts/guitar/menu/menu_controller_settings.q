...
script create_controller_settings_menu popup = 0
	...
	if (<popup>)
		...
		font = text_a6
		z = 5
		text_params = {parent = cs_vmenu type = TextElement font = <font> scale = 0.9 rgba = ($menu_unfocus_color) z_priority = <z> rot_angle = 1.5}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{pad_choose controller_settings_menu_choose_star_power params = {popup = <popup>}}
			{focus retail_menu_focus}
