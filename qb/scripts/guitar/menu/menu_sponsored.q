sponsored_menu_font = fontgrid_title_gh3
sponsor_info = {
	tier1 = {
		logo_texture = 0x31447d36
	...
	tier4 = {
		...
		sponsorship_desc = "Mackie thinks you're the next big thing. Don't let your head outgrow your body! They're sponsoring you with some cranktastic monitors so you can hear yourself over the drums."
		sponsorship_value = 1440
	}
	tier5 = {
		logo_texture = 0x31447d36
...
script create_sponsored_menu 
	...
	displaySprite parent = sponsored_container tex = (<sponsor>.logo_texture) pos = (450.0, 160.0) just = [center center] scale = 2 rot_angle = <rot>
	CreateScreenElement {
		type = TextElement
		parent = sponsored_container
	...
	displaySprite parent = continue_button tex = Sponsored_Pill pos = (-20.0, -27.0) scale = 1.75 rgba = [0 0 0 255]
