...
script training_2_1_explain 
	...
	training_play_sound Sound = EN_Tutorial_2A_01_LOU
	Wait 3 seconds ignoreslomo
	training_add_arrow id = training_arrow2 life = 10 pos = (532.0, 360.0) scale = 0.7
	training_wait_for_sound Sound = EN_Tutorial_2A_01_LOU Wait
...
script training_2_2_show_whammy 
	...
	training_show_task_header
	training_play_sound Sound = EN_Tutorial_2B_02_LOU Wait
	setslomo 1.0
	setslomo_song slomo = 1.0
endscript
...
script training_2_2_watch_for_star_power 
	...
	if (<sound_played> = false)
		...
		if (<elapsed_time> > 20.0 && ($player1_status.star_power_amount < 25))
			training_play_sound Sound = EN_Tutorial_2B_03_LOU
			sound_played = true
...
script training_2_2_lesson_complete 
	...
	UnPauseGame
	Wait 0.5 seconds
	training_play_sound Sound = EN_Tutorial_2B_04_LOU Wait
	safe_destroy id = tuning_complete_text
	Wait 1 seconds
endscript
...
script training_2_3_explain 
	setslomo 0.0
	setslomo_song slomo = 0.0
	training_play_sound Sound = EN_Tutorial_2C_01_LOU
	...
	doScreenElementMorph id = guitar_sprite rot_angle = 0 time = 1.0
	training_wait_for_sound Sound = EN_Tutorial_2C_01_LOU
...
script training_2_tutorial_complete_message 
	...
	training_play_sound Sound = EN_Tutorial_2C_02_God Wait
