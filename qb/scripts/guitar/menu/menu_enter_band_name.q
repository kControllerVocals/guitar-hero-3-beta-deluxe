...
script confirm_band_name 
	...
	if (<valid> = 0)
		...
		SetGlobalTags <bandname_id> params = {name = <new_string>}
		agora_update band_id = <bandname_id> name = <new_string> new_band
