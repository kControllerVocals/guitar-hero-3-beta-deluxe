...
script create_mp_select_mode_menu 
	...
	new_menu scrollid = scrolling_mp_select_mode_menu vmenuid = vmenu_mp_select_mode_menu menu_pos = (360.0, 440.0) exclusive_device = <exclusive_mp_controllers>
...
script menu_select_multiplayer_mode_attach_random_blood_splat 
	...
	SetScreenElementProps id = <splat_id> rgba = [100 100 100 250] pos = <splat_placement> rot_angle = <random_rot>
endscript
