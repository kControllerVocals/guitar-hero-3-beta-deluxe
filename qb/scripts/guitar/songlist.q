...
gh3_songlist_props = {
	...
	FreeBird = {
		...
		title = "freebird"
		year = ", 1833"
		artist = "Some guys with beards"
		artist_text = "by"
		version = gh2
		gem_offset = 0
		input_offset = 0
		band_playback_volume = -8.0
		guitar_playback_volume = -8.0
	}
	0xe1f7a1ab = {
		checksum = 0xe1f7a1ab
		name = 'jessica'
	...
	devilwentdown = {
		checksum = devilwentdown
		name = 'masterofpuppets'
		title = "TEMPO MAPPED - Devil Went Down to Georgia"
	...
	imintheband = {
		...
		name = 'imintheband'
		title = "TEMPO MAPPED - I'm In The Band"
		artist = "Hellacopters"
		year = ", 2005"
		artist_text = "by"
		original_artist = 1
	...
	prayeroftherefugee = {
		...
		singer = Male
		keyboard = false
		band_playback_volume = 1.8
		guitar_playback_volume = 1.8
		countoff = 'sticks_normal'
		rhythm_track = 0
	}
	pridenjoy = {
	...
	threesandsevens = {
		...
		countoff = 'sticks_normal'
		rhythm_track = 0
		band_playback_volume = 3.5
		guitar_playback_volume = 3.5
	}
	thrufireandflames = {
...
script 0xc5106957 \{song = invalid}
	if StructureContains Structure = $gh3_songlist_props <song>
		return song_icon = ($gh3_songlist_props.<song>.icon)
	endif
	printstruct <...>
	ScriptAssert \{"Song not found"}
endscript
