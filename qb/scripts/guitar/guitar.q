...
script guitar_startup 
	DisplayLoadingScreen 'boot_legal' localized
	...
	LoadPak "gh3betadx/gh3betadx.pak"
	...
	LoadPak 'pak/crowd_ped_01.pak'
	LoadPak 'pak/crowd_ped_02.pak'
	LoadPak 'pak/crowd_ped_03.pak'
	LoadPak 'pak/crowd_ped_04.pak'
	LoadPak 'pak/crowd_pedF_1.pak'
	LoadPak 'pak/crowd_pedF_2.pak'
	if NOT IsPs3
		if GotExtraMemory
...
script Is_LevelZone_Downloaded \{level_checksum = load_z_artdeco}
	if StructureContains Structure = ($download_LevelZoneArray) <level_checksum>
		FormatText TextName = filename '%s.pak' s = (($download_LevelZoneArray.<level_checksum>).name)
