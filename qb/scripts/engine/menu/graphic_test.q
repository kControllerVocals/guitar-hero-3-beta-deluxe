...
script launch_graphic_test 
	...
	SetScreenElementProps {
		id = graphic_test_anchor
		event_handlers = [{pad_start destroy_graphic_test}
			{pad_space test_graphic_switch params = {selection = test_graphic1}}
			{pad_back test_graphic_switch params = {selection = test_graphic2}}
			{pad_choose test_graphic_switch params = {selection = test_graphic3}}
			{pad_square test_graphic_switch params = {selection = test_graphic4}}
			{pad_up test_graphic_move params = {dir = up}}
			{pad_right test_graphic_move params = {dir = right}}
			{pad_down test_graphic_move params = {dir = down}}
			{pad_left test_graphic_move params = {dir = left}}
			{pad_r2 test_graphic_scale params = {dir = up}}
			{pad_l2 test_graphic_scale params = {dir = down}}
			{pad_r3 test_graphic_toggle_axis}
			{pad_r1 test_graphic_z params = {up}}
			{pad_l1 test_graphic_z params = {down}}
			{pad_l3 test_graphic_toggle_speed}
		]
		replace_handlers
	}
